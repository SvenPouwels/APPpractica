...
public class Main {
    ...
    public static void testGenericSorters() {
        InsertionSorterGeneric<Integer> is = new InsertionSorterGeneric<>();
        ...
        MergeSorterGeneric<Integer> ms = new MergeSorterGeneric<>();
        ...
        QuickSorterGeneric<Integer> qs = new QuickSorterGeneric<>();
